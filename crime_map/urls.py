...
urlpatterns = [
    ...
    path('crime_data/<str:crime_type>/<int:year>/<str:station>/', crime_data, name='crime_data'),
     path('crime_data/<str:crime_type>/<int:year>/<str:station>/', crime_data, name='crime_data_with_filters'),
]